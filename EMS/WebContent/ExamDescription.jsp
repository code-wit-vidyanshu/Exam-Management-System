...
<section class="AvailExam">
    ...
    <div class="container Exam-container">
        <form action="StartExam" method="post">
            <h2 class="text-center" style="padding-top: 20px;">Exams details of <%= session.getAttribute("userorganisation") %></h2>
            ...
            <div class="subject-list text-center">
			    ...
			    String passingCriteria = (String) s.getAttribute("passingCriteria");
